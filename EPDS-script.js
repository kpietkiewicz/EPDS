function test_it(entry) {
    ...
    var pyt_10;
       ...
       if (total > 12 || pyt_10 > 1){ alert('Uzyskany wynik  Edynburskiej Skali Depresji Poporodowej  wskazuje na występowanie ryzyka depresji, więc wskazana jest konsultacja z lekarzem lub psychologiem. Diagnoza depresji może być postawiona przez specjalistę wyłącznie na podstawie pełnego wywiadu i oceny stanu psychicznego. Nie zwlekaj i skonsultuj się jak najszybciej z  psychiatrą, lekarzem rodzinnym lub psychologiem. Tylko specjalista może zweryfikować wynik testu, postawić diagnozę depresji lub wykluczyć ją.') }
       else { alert('Uzyskany wynik nie wskazuje na prawdopodobieństwo występowania depresji. Jest to jednak narzędzie pomocnicze i jeśli podejrzewasz, że możesz mieć depresję, najlepiej skonsultuj się z psychiatrą, lekarzem rodzinnym lub psychologiem. Tylko specjalista może zweryfikować wynik testu: rozpoznać lub wykluczyć depresję.')}
